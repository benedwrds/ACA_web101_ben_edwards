  ...
  if( $(this).text()== "" && play){
      ...
      if (findWinner() != -1 && findWinner()!= ""){
        if(findWinner()== "X"){
          ...
          $('body').append('<button onclick="location.reload()">Play Again</button>');
          $('.winner').css('background-color' , '#e85e4f');
...
function findWinner(){
  ...
  sp2 = $('table tr:nth-child(1) td:nth-child(1)').text();
  sp3 = $('table tr:nth-child(1) td:nth-child(1)').text();
  sp4 = $('table tr:nth-child(2) td:nth-child(1)').text();
  sp5 = $('table tr:nth-child(2) td:nth-child(1)').text();
  sp6 = $('table tr:nth-child(2) td:nth-child(1)').text();
  sp7 = $('table tr:nth-child(3) td:nth-child(1)').text();
  sp8 = $('table tr:nth-child(3) td:nth-child(1)').text();
  sp9 = $('table tr:nth-child(3) td:nth-child(1)').text();
  //check rows
  if((sp1 == sp2) && (sp2 == sp3)){
    return sp3;
